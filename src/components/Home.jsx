    ...
    <main className="relative z-10 flex items-center justify-center min-h-screen px-5 sm:px-8 lg:px-6 py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div initial={{ opacity: 0, x: -60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} className="space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 1 }} className="flex flex-row gap-6 pt-8">
              <a href="#projects" className="px-6 py-3 bg-linear-to-r from-gray-700 to-gray-800 text-white font-semibold text-lg rounded-full shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 border border-gray-600">
                View Projects
              </a>
              <a
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.4 }} className="flex justify-center lg:justify-end">
